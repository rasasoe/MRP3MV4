...
*대표 이미지(클릭 시 데모 영상 재생): MRP3MV4 로봇 상단 뷰 — 컨트롤 박스와 홀로노믹 휠이 보입니다.*

> 참고: 현재 서버에 ffmpeg 설치 권한이 없어 GIF를 자동 생성하지 못했습니다. GIF가 필요하시면 원하는 시작/종료 시간을 알려주시거나, GIF 파일을 직접 업로드해 주시면 README에 바로 표시하겠습니다.
